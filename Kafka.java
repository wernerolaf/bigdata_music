...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		props2.put("bootstrap.servers", "sandbox.hortonworks.com:2181");
		...
		props2.put("key.deserializer", "org.apache.kafka.common.serialization.ByteArraySerializer");
		...
		while (true) {
			j = 0;
			ConsumerRecords<String, String> records = consumer.poll(chunk_size);
